...
#define ck_version_s _CK_VERSION

#define ck_info_s _CK_INFO
...
#define ck_slot_info_s _CK_SLOT_INFO
#define slot_description slotDescription
#define hardware_version hardwareVersion
#define firmware_version firmwareVersion

#define ck_token_info_s _CK_TOKEN_INFO_s
...
#define ck_session_info_s _CK_SESSION_INFO
...
#define ck_mechanism_info_s _CK_MECHANISM_INFO
...
#define ck_function_list_s _CK_FUNCTION_LIST_s
...
#define ck_c_initialize_args_s _CK_C_INITIALIZE_ARGS
...
struct ck_info_s
{
  struct ck_version_s cryptoki_version;
...
struct ck_slot_info_s
{
  unsigned char slot_description[64];
  unsigned char manufacturer_id[32];
  ck_flags_t flags;
  struct ck_version_s hardware_version;
  struct ck_version_s firmware_version;
};
...
struct ck_rsa_pkcs_pss_params_s {
...
/* Forward reference.  */
struct ck_function_list_s;

#define _CK_DECLARE_FUNCTION(name, args)	\
typedef ck_rv_t (*CK_ ## name) args;		\
ck_rv_t CK_SPEC name args

_CK_DECLARE_FUNCTION (C_Initialize_s, (void *init_args));
_CK_DECLARE_FUNCTION (C_Finalize, (void *reserved));
_CK_DECLARE_FUNCTION (C_GetInfo, (struct ck_info_s *info));
_CK_DECLARE_FUNCTION (C_GetFunctionList,
		      (struct ck_function_list_s **function_list));

_CK_DECLARE_FUNCTION (C_GetSlotList_s,
		      (unsigned char token_present, ck_slot_id_t *slot_list,
		       unsigned long count));
_CK_DECLARE_FUNCTION (C_GetSlotInfo,
		      (ck_slot_id_t slot_id, struct ck_slot_info_s *info));
_CK_DECLARE_FUNCTION (C_GetTokenInfo_s,
		      (ck_slot_id_t slot_id, struct ck_token_info_s *info));
...
_CK_DECLARE_FUNCTION (C_GetMechanismInfo,
		      (ck_slot_id_t slot_id, ck_mechanism_type_t type,
		       struct ck_mechanism_info_s *info));
_CK_DECLARE_FUNCTION (C_InitToken_s,
		      (ck_slot_id_t slot_id, unsigned char *pin,
		       unsigned long pin_len, unsigned char *label, unsigned char* pImei));
_CK_DECLARE_FUNCTION (C_InitPIN_s,
		      (ck_session_handle_t session, unsigned char *pin,
		       unsigned long pin_len));
_CK_DECLARE_FUNCTION (C_SetPIN_s,
		      (ck_session_handle_t session, unsigned char *old_pin,
		       unsigned long old_len, unsigned char *new_pin,
		       unsigned long new_len));

_CK_DECLARE_FUNCTION (C_OpenSession_s,
		      (ck_slot_id_t slot_id, ck_flags_t flags,
		       void *application, ck_notify_t notify,
		       ck_session_handle_t *session));
_CK_DECLARE_FUNCTION (C_CloseSession_s, (ck_session_handle_t session));
_CK_DECLARE_FUNCTION (C_CloseAllSessions_s, (ck_slot_id_t slot_id));
_CK_DECLARE_FUNCTION (C_GetSessionInfo,
		      (ck_session_handle_t session,
		       struct ck_session_info_s *info));
...
_CK_DECLARE_FUNCTION (C_Login_s,
		      (ck_session_handle_t session, ck_user_type_t user_type,
		       unsigned char *pin, unsigned long pin_len));
_CK_DECLARE_FUNCTION (C_Logout_s, (ck_session_handle_t session));
...
_CK_DECLARE_FUNCTION (C_GetObjectSize,
		      (ck_session_handle_t session,
		       ck_object_handle_t object,
		       unsigned long *size));
_CK_DECLARE_FUNCTION (C_GetAttributeValue_s,
		      (ck_session_handle_t session,
		       ck_object_handle_t object,
		       struct ck_attribute *templ,
		       unsigned long count));
_CK_DECLARE_FUNCTION (C_SetAttributeValue,
		      (ck_session_handle_t session,
		       ...
		       struct ck_attribute *templ,
		       unsigned long count));
_CK_DECLARE_FUNCTION (C_FindObjectsInit_s,
		      (ck_session_handle_t session,
		       struct ck_attribute *templ,
		       unsigned long count));
_CK_DECLARE_FUNCTION (C_FindObjects_s,
		      (ck_session_handle_t session,
		       ck_object_handle_t *object,
		       unsigned long max_object_count,
		       unsigned long *object_count));
_CK_DECLARE_FUNCTION (C_FindObjectsFinal_s,
		      (ck_session_handle_t session));
...
_CK_DECLARE_FUNCTION (C_DecryptInit_s,
		      (ck_session_handle_t session,
		       struct ck_mechanism *mechanism,
		       ck_object_handle_t key));
_CK_DECLARE_FUNCTION (C_Decrypt_s,
		      (ck_session_handle_t session,
		       unsigned char *encrypted_data,
		       unsigned long encrypted_data_len,
		       unsigned char *data, unsigned long *data_len));
...
_CK_DECLARE_FUNCTION (C_DigestInit_s,
		      (ck_session_handle_t session,
		       struct ck_mechanism *mechanism));
_CK_DECLARE_FUNCTION (C_Digest_s,
		      (ck_session_handle_t session,
		       unsigned char *data, unsigned long data_len,
...
_CK_DECLARE_FUNCTION (C_SignInit_s,
		      (ck_session_handle_t session,
		       struct ck_mechanism *mechanism,
		       ck_object_handle_t key));
_CK_DECLARE_FUNCTION (C_Sign_s,
		      (ck_session_handle_t session,
		       unsigned char *data, unsigned long data_len,
...
_CK_DECLARE_FUNCTION (C_SignUpdate,
		      (ck_session_handle_t session,
		       unsigned char *part, unsigned long part_len));
_CK_DECLARE_FUNCTION (C_SignFinal_s,
		      (ck_session_handle_t session,
		       unsigned char *signature,
		       unsigned long *signature_len));
...
_CK_DECLARE_FUNCTION (C_GenerateKey,
		      (ck_session_handle_t session,
		       ...
		       unsigned long count,
		       ck_object_handle_t *key));
_CK_DECLARE_FUNCTION (C_GenerateKeyPair_s,
		      (ck_session_handle_t session,
		       struct ck_mechanism *mechanism,
...
struct ck_function_list_s
{
  struct ck_version_s version;
  CK_C_Initialize_s C_Initialize_s;
  CK_C_Finalize C_Finalize;
  CK_C_GetInfo C_GetInfo;
  CK_C_GetFunctionList C_GetFunctionList;
  CK_C_GetSlotList_s C_GetSlotList_s;
  CK_C_GetSlotInfo C_GetSlotInfo;
  CK_C_GetTokenInfo_s C_GetTokenInfo_s;
  CK_C_GetMechanismList C_GetMechanismList;
  CK_C_GetMechanismInfo C_GetMechanismInfo;
  CK_C_InitToken_s C_InitToken_s;
  CK_C_InitPIN_s C_InitPIN_s;
  CK_C_SetPIN_s C_SetPIN_s;
  CK_C_OpenSession_s C_OpenSession_s;
  CK_C_CloseSession_s C_CloseSession_s;
  CK_C_CloseAllSessions_s C_CloseAllSessions_s;
  CK_C_GetSessionInfo C_GetSessionInfo;
  CK_C_GetOperationState C_GetOperationState;
  CK_C_SetOperationState C_SetOperationState;
  CK_C_Login_s C_Login_s;
  CK_C_Logout_s C_Logout_s;
  CK_C_CreateObject C_CreateObject;
  CK_C_CopyObject C_CopyObject;
  CK_C_DestroyObject C_DestroyObject;
  CK_C_GetObjectSize C_GetObjectSize;
  CK_C_GetAttributeValue_s C_GetAttributeValue_s;
  CK_C_SetAttributeValue C_SetAttributeValue;
  CK_C_FindObjectsInit_s C_FindObjectsInit_s;
  CK_C_FindObjects_s C_FindObjects_s;
  CK_C_FindObjectsFinal_s C_FindObjectsFinal_s;
  CK_C_EncryptInit C_EncryptInit;
  CK_C_Encrypt C_Encrypt;
  CK_C_EncryptUpdate C_EncryptUpdate;
  CK_C_EncryptFinal C_EncryptFinal;
  CK_C_DecryptInit_s C_DecryptInit_s;
  CK_C_Decrypt_s C_Decrypt_s;
  CK_C_DecryptUpdate C_DecryptUpdate;
  CK_C_DecryptFinal C_DecryptFinal;
  CK_C_DigestInit_s C_DigestInit_s;
  CK_C_Digest_s C_Digest_s;
  CK_C_DigestUpdate C_DigestUpdate;
  CK_C_DigestKey C_DigestKey;
  CK_C_DigestFinal C_DigestFinal;
  CK_C_SignInit_s C_SignInit_s;
  CK_C_Sign_s C_Sign_s;
  CK_C_SignUpdate C_SignUpdate;
  CK_C_SignFinal_s C_SignFinal_s;
  ...
  CK_C_GenerateKeyPair_s C_GenerateKeyPair_s;
...
typedef struct ck_version_s CK_VERSION_s;
typedef struct ck_version_s *CK_VERSION_PTR;

typedef struct ck_info_s CK_INFO_s;
typedef struct ck_info_s *CK_INFO_PTR_s;

typedef ck_slot_id_t *CK_SLOT_ID_PTR;

typedef struct ck_slot_info_s CK_SLOT_INFO_s;
typedef struct ck_slot_info_s *CK_SLOT_INFO_PTR_s;

typedef struct ck_token_info_s CK_TOKEN_INFO_s;
typedef struct ck_token_info_s *CK_TOKEN_INFO_PTR_s;

typedef ck_session_handle_t *CK_SESSION_HANDLE_PTR;

typedef struct ck_session_info_s CK_SESSION_INFO_s;
typedef struct ck_session_info_s *CK_SESSION_INFO_PTR_s;
...
typedef struct ck_date_s CK_DATE_s;
typedef struct ck_date_s *CK_DATE_PTR;
...
typedef struct ck_mechanism_info_s CK_MECHANISM_INFO_s;
typedef struct ck_mechanism_info_s *CK_MECHANISM_INFO_PTR_s;

typedef struct ck_rsa_pkcs_pss_params_s CK_RSA_PKCS_PSS_PARAMS_s;
typedef struct ck_rsa_pkcs_pss_params_s *CK_RSA_PKCS_PSS_PARAMS_PTR_s;

typedef struct ck_function_list_s CK_FUNCTION_LIST_s;
typedef struct ck_function_list_s *CK_FUNCTION_LIST_PTR_s;
typedef struct ck_function_list_s **CK_FUNCTION_LIST_PTR_PTR_s;

typedef struct ck_c_initialize_args_s CK_C_INITIALIZE_ARGS_s;
typedef struct ck_c_initialize_args_s *CK_C_INITIALIZE_ARGS_PTR_s;
...
#undef ck_slot_info_s
#undef slot_description
#undef hardware_version
#undef firmware_version

#undef ck_token_info_s
#undef serial_number
...
#undef ck_mechanism_info_s
#undef min_key_size
#undef max_key_size

#undef ck_rsa_pkcs_pss_params_s
#undef hash_alg
#undef salt_len
