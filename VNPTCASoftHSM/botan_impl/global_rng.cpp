...
//#include "../botan/rdrand.h"
//#endif

//#if defined(BOTAN_HAS_ENTROPY_SRC_DEV_RANDOM)
//  #include "../botan/dev_random.h"
//#endif
...
#if defined(BOTAN_HAS_ENTROPY_SRC_UNIX)
	rng->add_entropy_source(new Unix_EntropySource(split_on(
...
RandomNumberGenerator* Library_State::make_global_rng(Algorithm_Factory& af,
	...
	MessageAuthenticationCode* macAlgo = af.make_mac("HMAC(SHA-160)");

	MessageAuthenticationCode* macProv = af.make_mac("HMAC(SHA-160)");

	rng = new HMAC_RNG(macAlgo, macProv);
