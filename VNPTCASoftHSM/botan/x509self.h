...
public:
	 ...
	 */
	X509_Cert_Options(const std::string& opts = "", u32bit expire_time = 365
			* 24 * 60 * 60);
};
...
// Hoang them de sinh PKCS#10 Request ngoai ham Main
long test();
 ...
 */
X509_Certificate
create_self_signed_cert(const X509_Cert_Options& opts, const Private_Key& key,
