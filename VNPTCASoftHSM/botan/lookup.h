...
*/
 bool have_algorithm(const std::string& algo_spec);
...
*/
 size_t block_size_of(const std::string& algo_spec);
...
*/
 size_t output_length_of(const std::string& algo_spec);
...
BOTAN_DEPRECATED("Retrieve object you want and then call key_spec")
 size_t min_keylength_of(const std::string& algo_spec);
...
*/
BOTAN_DEPRECATED("Retrieve object you want and then call key_spec")
 size_t max_keylength_of(const std::string& algo_spec);
...
*/
BOTAN_DEPRECATED("Retrieve object you want and then call key_spec")
 size_t keylength_multiple_of(const std::string& algo_spec);
