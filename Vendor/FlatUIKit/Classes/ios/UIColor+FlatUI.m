...
+ (UIColor *)tableBackground {
  return [UIColor colorFromHexCode:@"e9e9e9"];
}
...
+ (UIColor *)violetUnderBarColor {
  return [UIColor colorFromHexCode:@"af008d"];
}
...
+ (UIColor *)blueMenuColor {
  return [UIColor colorFromHexCode:@"3c598a"];
}

+ (UIColor *)blendedColorWithForegroundColor:(UIColor *)foregroundColor
                             backgroundColor:(UIColor *)backgroundColor
                                percentBlend:(CGFloat)percentBlend {
  CGFloat onRed, offRed, newRed, onGreen, offGreen, newGreen, onBlue, offBlue,
      newBlue, onWhite, offWhite;
