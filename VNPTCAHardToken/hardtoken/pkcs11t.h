...
typedef CK_VERSION CK_PTR CK_VERSION_PTR_H;
...
typedef struct CK_TOKEN_INFO {
  ...
  CK_CHAR       serialNumber[14];    /* blank padded */
...
typedef CK_ATTRIBUTE_H CK_PTR CK_ATTRIBUTE_PTR_H;
...
typedef CK_MECHANISM_H CK_PTR CK_MECHANISM_PTR_H;
...
typedef struct CK_CMS_SIG_PARAMS {
  ...
  CK_MECHANISM_PTR_H      pSigningMechanism;
  CK_MECHANISM_PTR_H      pDigestMechanism;
