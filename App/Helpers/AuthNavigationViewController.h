...
+ (id)controllerWithPreview:(NSString *)title data:(NSData *)data mimeType:(NSString *)mimeType;
- (id)initWithPreview:(NSString *)title data:(NSData *)data mimeType:(NSString *)mimeType;
